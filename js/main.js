...
$(document).ready(function() {
	// Display header login form and hide button#login when button#login is clicked
	$("button#login").click(function(e){
		$("form#loginform").css("display","block");
		$("button#login").css("display","none");
	});
	
	$(".editTimestamp").click(function(){
		$("#updateTimestampForm" + event.target.id).css("display", "block");
		$("#"+event.target.id).css("display", "none");
		$("#timestamp"+event.target.id).css("display", "none");
	});
