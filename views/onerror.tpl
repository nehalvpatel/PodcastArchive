    ...
    <body data-type="{{ @type }}">
        <aside class="sidebar">
            <nav id="sidebar">
                ...
                <h3><span>Episodes</span><a title="Random Episode" href="{{ @domain }}episode/random" class="random-button timelined"><i class="icon-random"></i></a></h3>
        ...
        <section class="main">
            ...
            <div id="container">
				<div class="error">
					<img alt="Lefty" title="Lefty" src="{{ @domain }}img/404.png">
